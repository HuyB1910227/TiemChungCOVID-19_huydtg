...
class ManagerVaccinationHistoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //             $vacHistories[] = $vaccinationHistory;
        //         }
        //     }
        // return view('manager.vaccination-history.index', compact('vacHistories'));
        ...
        return view('manager.vaccination-history.index', compact('vacHistories', 'vaccines', 'vaccinationHistories'));
    }
