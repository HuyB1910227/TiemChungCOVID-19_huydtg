...
class ManagerVaccinationRegistrationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.vaccination-registration.index', compact('filteredData'));
    }
    ...
    public function show($id)
    {
        ...
        return view('manager.vaccination-registration.show', compact('reg', 'Y', 'U'));
    }
