...
@section('breadcrumb')
        ...
        <li class="breadcrumb-item" aria-current="page">Thêm cơ sở</li>
        <li class="text-uppercase ml-auto font-weight-bold">Quản lý cơ sở</li>

@endsection

@section('main-content')
{{-- <h2 class="text-center"> Thêm cơ sở</h2> --}}
<div class="separator"></div>
<div class="card w-50 m-auto shadow">
    <div class="card-body">
        <form action="{{route('admin.immunizationUnit.store')}}" method="post" id="frmQLVC">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="operating_license" id="operating_license" class="form-control" value="{{old('operating_license')}}">
