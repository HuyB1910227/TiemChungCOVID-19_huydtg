...
@section('breadcrumb')
        <li class="breadcrumb-item"><a href="{{route('employee.vaccination.registration')}}">Đăng ký tiêm chủng</a></li>
                        ...
                        <div class="col">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>{{$reg->recent_injection_date ? date("d/m/Y", strtotime($reg->recent_injection_date)) : ""}}</td>
                                </tr>
                                <tr>
                                    <th>Số điện thoại:</th>
