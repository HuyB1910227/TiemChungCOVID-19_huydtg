...
@section('breadcrumb')
        <li class="breadcrumb-item"><a href="{{route('employee.vaccination.execution')}}">Xử lý tiêm chủng</a></li>
...
@section('main-content')
    ...
    @endif
    {{-- <h2 class="text-center text-uppercase"> Chi tiết phiếu đăng ký</h2> --}}
                        ...
                        <div class="col">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>{{$reg->vaccine_id != null ? $reg->vaccine->name : ""}}</td>
                                </tr>
                                <tr>
