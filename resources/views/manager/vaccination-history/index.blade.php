        ...
        <div class="row p-3">
            ...
            <div class="col-12">
                ...
                <div class="form-group ">
                    ...
                    <a href="{{route('manager.vaccination.history')}}" class="btn btn-primary"><i class="fa-solid fa-repeat"></i></a>
                </div>
            ...
            <tbody>
                @foreach ($vacHistories as $vacHistory)
                    <tr>
                        ...
                        <td >
                            <div class="d-flex">
                                <form action="{{route('manager.vaccination.history.show', $vacHistory->id)}}" method="post">
                                    @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('manager.vaccination.history.update', $vacHistory->id)}}" method="post" id="frmSuaTrangThai">
                        @csrf
